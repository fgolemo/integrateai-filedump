...
NOTE_SHIFT = -5 # where is the left hand note grabbed (negative = earlier in time)
...
# extrema = (np.around(strumming_d1,1) == 0.0).nonzero()
#
# print (strumming_d1)
# print (extrema)
# quit()
...
for e in extrema:
    ...
    if data[3, e - FRAMES_AFTER_PEAK + 1] - data[3, e] < MIN_DIFFERENCE:
        keep = False
...
# RESULTS are stored in variable: out
